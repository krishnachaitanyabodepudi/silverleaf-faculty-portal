...
<div class="hero-section">
  <div class="hero-content">
    <div class="hero-badge">Master's Level Project</div>
    <h1 class="project-title">Silverleaf University Faculty Portal</h1>
    <p class="tagline">AI-Powered Faculty Management System</p>
    <p class="subtitle">A comprehensive full-stack faculty portal built with React, Node.js, and AI-powered assistance using Google Gemini</p>
    <div class="hero-buttons">
      <a href="/executive-summary" class="btn btn-primary">Explore Project</a>
      <a href="https://github.com/krishnachaitanyabodepudi/silverleaf-faculty-portal" class="btn btn-secondary" target="_blank">View on GitHub</a>
    </div>
  </div>
</div>
  ...
  <div class="container">
    ...
    <div class="features-grid">
      <div class="feature-card">
        ...
        <p>Overview of courses, students, and recent activity</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">📅</div>
        <h3>Class Timetable</h3>
        <p>Manage and view class schedules</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">📚</div>
        <h3>Syllabus Management</h3>
        <p>Create, edit, and organize course syllabi</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">🎓</div>
        <h3>Curriculum Overview</h3>
        <p>Explore academic programs and course requirements</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">🤖</div>
        <h3>AI Assistant</h3>
        <p>Get help with grading, lesson planning, and course management</p>
      </div>
    </div>
  </div>
</div>
...
<div class="page-content">
  ...
  <p>
    The Silverleaf University Faculty Portal is a comprehensive full-stack application designed to 
    revolutionize faculty management and enhance the teaching experience. Built with modern 
    technologies including React, Node.js, and Google Gemini AI, this portal provides 
    intelligent assistance for grading, lesson planning, and course management.
  </p>
  ...
  <ul>
    ...
    <li>Google Gemini API for AI assistance</li>
  </ul>
</div>
...
>>>>>>> e9ea9e913c8f385698540592815e8d6dcb8e5ca2
